...
bool CSoundMgrS::OpenFile(char * filename, vector<string> &file_list)
{
...
bool CSoundMgrS::Play(const char * filename, bool repeat)
{
...
void CSoundMgrS::Pause(bool pause)		
{
	if(pause)
	{
